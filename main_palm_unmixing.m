...
% --------------------------------------------------------------
img_name = '_4d_exp_gaussian_mult_noise1';
...
if strcmp(type_init,'create')
    ...
    [A0,M0,B0,alpha0,BP0] = variables_initialization(init_type,PET,K,V,A_gt,lbd,gamma,alpha_lim,B_lim);
...
[A_palm,M_palm,B_palm,elapsedTime_PALM,err,err_beta,err_A,err_M,obj_fct_palm,err_A1,ni_palm] = slmm_unmix(PET,A_palm,M_palm,A_gt,M_gt,B_gt,Niter,vect_prop,B_palm,1e-3,'PLMM',{M_ROI},'PENALTY M',{'DIFFERENCE',beta*C},'PENALTY A',{'SMOOTH',eta*C},'PENALTY B',{'SPARSE',lbd*C});
...
% %--------------------------------------------------------------
% 
% [A_cnu,M_cnu,B_cnu,alpha_cnu,BP_cnu,Q,elapsedTime,obj_fct,ni] = PALM_unmix(PET,A0,M0,B0,alpha0,Niter,lbd*C,gamma*C,beta*C,eta*C,alpha_lim,B_lim,epsilon);
%--------------------------------------------------------------
% Compute SNR
%--------------------------------------------------------------
...
plot_PALM_brain_results_4D(PET,A_palm,B_palm,M_palm,A_gt,BP_gt,M_gt,A0,M0,BP0,B_palm,obj_fct_palm,4,img_type);
